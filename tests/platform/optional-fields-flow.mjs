...
console.log('Optional base fields, hidden empty columns and identity-aware voting flow passed: consent, encrypted submission, review, candidate confirmation, vote, duplicate rejection, result, scoped reset.');
